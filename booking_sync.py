    ...
    try:
        ...
        for feed in feeds:
            try:
                ...
                # Applies to both iCal-only rows and rows that were promoted
                # to include a Channex booking id. If they're gone from the
                # feed, the OTA has cancelled them and we need to unblock
                # the dates across channels.
                cur.execute(
